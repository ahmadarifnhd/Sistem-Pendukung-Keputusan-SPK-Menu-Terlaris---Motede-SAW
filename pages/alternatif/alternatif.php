<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($isi[0] >= 10) {
      ...
      $cekData = mysqli_query($koneksi, "SELECT * FROM data_alternatif WHERE Nama_Menu = '$namaAlternatif'");
      $result = mysqli_fetch_assoc($cekData);

      if ($namaAlternatif == $result['Nama_Menu']) {
        echo "<script>
        ...
        $query = "INSERT INTO data_alternatif VALUES ('$newId', '$namaAlternatif', '$jenisMenu')";
              ...
              <table class="table table-bordered">
                <thead>
                  <tr class="text-center">
                    ...
                    <th class="text-nowrap">Jenis Menu</th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="text-center">
                      ...
                      <td class="text-nowrap"><?= $items['Nama_Menu'];?></td>
                      <td class="text-nowrap"><?= $items['Jenis_Menu'];?></td>
